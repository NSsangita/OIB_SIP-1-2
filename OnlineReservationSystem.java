...
public class OnlineReservationSystem {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            int choice = scanner.nextInt(); //store the input in choice variables
    ...
    private static void makeReservation(String username, Scanner scanner) {
        ...
        if (reservationSystem.makeReservation(username, reservationDetails)) {
            ...
            System.out.println("Reservation already exists for this user.");//if this user have a reservation then it shows reservation already exists
        }
    }
